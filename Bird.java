...
public enum Bird implements Card
{
	...
	// ANNAS_HUMMINGBIRD "birds/anna's_hummingbird.png" this bird ain't happening
	...
	BARN_OWL("BARN OWL", "birds/barn_owl.png", 4, 107, 5, new String[] {"forest", "grassland", "wetland"}, "BROWN", "Predator", "and 2rat", "Cavity",BirdAction.ROLLDICEANDFINDRAT),
	BARN_SWALLOW("BARN SWALLOW", "birds/barn_swallow.png", 2, 107, 3, new String[] {"grassland", "wetland"}, "BROWN", "Flocking", "and 1worm", "Wild", BirdAction.TUCK1BIRDANDDRAW1BIRD),
	...
	// BARROWS_GOLDENEYE("BARROW'S GOLDENEYE", "birds/barrow's_goldeneye.png", 4, 71, 5, new String[] {"wetland"}, "PINK", "Other", "and 1fish 1seed 1worm", "Cavity", BirdAction.LAYEGGTHENLAYCAVITY),
	...
	BELTED_KINGFISHER("BELTED KINGFISHER", "birds/belted_kingfisher.png", 4, 53, 4, new String[] {"wetland"}, "PINK", "Other", "and 1any 1fish", "Wild", BirdAction.PLAYWETLANDANDGAIN1FISH), 
	...
	// BLACK_TERN this bird ain't happening
	BLACK_VULTURE("BLACK VULTURE", "birds/black_vulture.png", 1, 150, 2, new String[] {"forest"}, "PINK", "Other", "and 0rat", "Cavity", BirdAction.IFPREDATORSUCCESSGAIN1FOOD),
	...
	BLACK_BILLED_MAGPIE("BLACK BILLED MAGPIE", "birds/black-billed_magpie.png", 3, 64, 3, new String[] {"grassland"}, "PINK", "Other", "and 2any", "Wild", BirdAction.IFPREDATORSUCCESSGAIN1FOOD),
	...
	BLACK_NECKED_STILT("BLACK NECKED STILT", "birds/black-necked_stilt.png", 2, 74, 4, new String[] {"wetland"}, "WHITE", "CardDrawing", "and 2worm", "Ground", BirdAction.DRAW2BIRDCARDS),
	BLACK_SKIMMER("BLACK SKIMMER", "birds/black_skimmer.png", 2, 112, 6, new String[] {"wetland"}, "BROWN", "Predator", "and 2fish", "Ground", BirdAction.ROLLDICEANDFINDFISH),
	...
	// BRONZED_COWBIRD("BRONZED COWBIRD", "birds/bronzed_cowbird.png", 0, 36, 5, new String[] {"grassland"}, "PINK", "Other", "and 1seed 1worm", "None", BirdAction.LAYEGGTHENLAYBOWL),
	...
	// BROWN_HEADED_COWBIRD("BROWN HEADED COWBIRD", "birds/brown-headed_cowbird.png", 0, 30, 3, new String[] {"grassland"}, "PINK", "Other", "and 1seed", "None", BirdAction.LAYEGGTHENLAYBOWL),
	...
	// CLARKS_GREBE this bird ain't happening
	...
	// COMMON_YELLOWTHROAT this bird ain't happening 
	...
	// DOWNY_WOODPECKER "birds/downy_woodpecker.png" this bird ain't happening
	// EASTERN_BLUEBIRD "birds/eastern_bluebird.png" this bird ain't happening
    EASTERN_KINGBIRD("EASTERN KINGBIRD", "birds/eastern_kingbird.png", 2, 38, 2, new String[] {"forest", "grassland", "wetland"}, "PINK", "Other", "or 1berry 1worm", "Bowl", BirdAction.PLAYFORESTANDGAIN1WORM),
	...
	// FORESTERS_TERN this bird ain't happening
	...
	// GRAY_CATBIRD "birds/gray_catbird.png" this bird ain't happening
	// GREAT_BLUE_HERON "birds/great_blue_heron.png" this bird ain't happening
	...
	// GREAT_EGRET "birds/great_egret.png" this bird ain't happening
	...
	// HOODED_MERGANSER "birds/hooded_merganser.png" this bird ain't happening
    ...
    HORNED_LARK("HORNED LARK", "birds/horned_lark.png", 4, 30, 5, new String[] {"grassland"}, "PINK", "Flocking", "and 1seed 1worm", "Ground", BirdAction.PLAYGRASSLANDANDTUCK),  
	...
	// HOUSE_WREN "birds/house_wren.png" this bird ain't happening
	...
	// LAZULI_BUNTING this bird ain't happening 
	...
	// LOGGERHEAD_SHRIKE("LOGGERHEAD SHRIKE", "birds/loggerhead_shrike.png", 4, 30, 3, new String[] {"grassland", "wetland"}, "PINK", "Other", "and 1rat 1worm", "Bowl", BirdAction.GETRATTHENCACHERAT),
	...
	// MOUNTAIN_BLUEBIRD "birds/mountain_bluebird.png" this bird ain't happening
	...
	// NORTHERN_MOCKINGBIRD "birds/northern_mockingbird.png" this bird ain't happening
	...
	// PIED_BILLED_GREBE this bird ain't happening
	// PILEATED_WOODPECKER this bird ain't happening
	...
	// RED_BREASTED_MERGANSER this bird ain't happening
	...
	RED_TAILED_HAWK("RED TAILED HAWK", "birds/red-tailed_hawk.png", 2, 124, 5, new String[] {"forest", "grassland", "wetland"}, "BROWN", "Predator", "and 2rat", "Platform", BirdAction.DRAW1BIRDANDTUCKIF75CM),
	...
	// RUBY_CROWNED_KINGLET this bird ain't happening
	// RUBY_THROATED_HUMMINGBIRD this bird ain't happening
	// RUDDY_DUCK this bird ain't happening
	...
	// SAVANNAH_SPARROW "birds/savannah_sparrow.png" this bird ain't happening
	...
	SNOWY_EGRET("SNOWY EGRET", "birds/snowy_egret.png", 2, 104, 4, new String[] {"wetland"}, "BROWN", "Predator", "or 1fish 1worm", "Platform", BirdAction.ROLLDICEANDFINDFISH),
	SONG_SPARROW("SONG SPARROW", "birds/song_sparrow.png", 5, 20, 0, new String[] {"forest", "grassland", "wetland"}, "BROWN", "Other", "or 1berry 1seed 1worm", "Bowl", BirdAction.MOVEIFATVERYRIGHT),
	SPOTTED_OWL("SPOTTED OWL", "birds/spotted_owl.png", 1, 102, 5, new String[] {"forest"}, "WHITE", "CardDrawing", "and 2rat", "Cavity", BirdAction.DRAW2BONUSKEEP1),
	SPOTTED_SANDPIPER("SPOTTED SANDPIPER", "birds/spotted_sandpiper.png", 2, 38, 5, new String[] {"wetland"}, "BROWN", "CardDrawing", "and 1worm", "Ground", BirdAction.ALLDRAW1BIRD),
	SPOTTED_TOWHEE("SPOTTED TOWHEE", "birds/spotted_towhee.png", 4, 28, 0, new String[] {"forest", "grassland"}, "BROWN", "Other", "or 1berry 1seed 1worm", "Ground", BirdAction.GET1SEED),
	SPRAGUES_PIPIT("SPRAGUE'S PIPIT", "birds/sprague's_pipit.png", 3, 25, 3, new String[] {"grassland"}, "WHITE", "CardDrawing", "and 1seed 1worm", "Ground", BirdAction.DRAW2BONUSKEEP1),
	STELLERS_JAY("STELLER'S JAY", "birds/steller's_jay.png", 2, 48, 5, new String[] {"forest"}, "BROWN", "Other", "and 1any 2seed", "Bowl", BirdAction.GAIN1SEEDANDCACHE),
	...
	// TUFTED_TITMOUSE "birds/tufted_titmouse.png" this bird ain't happening
	TURKEY_VULTURE("TURKEY VULTURE", "birds/turkey_vulture.png", 1, 170, 1, new String[] {"forest", "grassland", "wetland"}, "PINK", "Other", "and 0rat", "Cavity", BirdAction.IFPREDATORSUCCESSGAIN1FOOD),
	...
	// WESTERN_MEADOWLARK this bird ain't happening
	...
	WHITE_FACED_IBIS("WHITE FACED IBIS", "birds/white-faced_ibis.png", 2, 91, 8, new String[] {"wetland"}, "BROWN", "Predator", "and 1fish 2worm", "Platform", BirdAction.ROLLDICEANDFINDFISH),
	WHITE_THROATED_SWIFT("WHITE THROATED SWIFT", "birds/white-throated_swift.png", 2, 38, 2, new String[] {"grassland"}, "BROWN", "Flocking", "and 1worm", "Cavity", BirdAction.TUCK1BIRDANDLAY1EGG),
	WHOOPING_CRANE("WHOOPING CRANE", "birds/whooping_crane.png", 1, 221, 6, new String[] {"wetland"}, "WHITE", "CardDrawing", "and 3any", "Ground", BirdAction.DRAW2BONUSKEEP1),
	...
	// WOOD_DUCK this bird ain't happening
	...
	//YELLOW_BILLED_CUCKOO("YELLOW BILLED CUCKOO", "birds/yellow-billed_cuckoo.png", 2, 46, 5, new String[] {"forest"}, "PINK", "Other", "and 1any 2worm", "Platform", BirdAction.LAYEGGTHENLAYBOWL),
	...
	public static HashSet<Bird> getBonusName(String type)
	{
		if (type.equals("anatomist"))
		{
			...
			DOUBLE_CRESTED_CORMORANT, GREAT_CRESTED_FLYCATCHER, BLACK_BELLIED_WHISTLING_DUCK, BLACK_CHINNED_HUMMINGBIRD, BLACK_CROWNED_NIGHT_HERON, WHITE_THROATED_SWIFT, 
			RED_BELLIED_WOODPECKER, RED_BREASTED_NUTHATCH, WHITE_FACED_IBIS, YELLOW_BELLIED_SAPSUCKER, 
			YELLOW_BREASTED_CHAT, YELLOW_HEADED_BLACKBIRD, YELLOW_RUMPED_WARBLER, RED_TAILED_HAWK, ROSEATE_SPOONBILL, SCISSOR_TAILED_FLYCATCHER, WHITE_BREASTED_NUTHATCH, 
			WHITE_CROWNED_SPARROW, ASH_THROATED_FLYCATCHER, BLACK_BILLED_MAGPIE}; // BARROWS_GOLDENEYE | YELLOW_BILLED_CUCKOO | LOGGERHEAD_SHRIKE | BROWN_HEADED_COWBIRD
		}
		if (type.equals("cartographer"))
		{
			Bird[] birds = {AMERICAN_BITTERN, AMERICAN_COOT, AMERICAN_CROW, AMERICAN_GOLDFINCH, AMERICAN_KESTREL, AMERICAN_REDSTART, 
			AMERICAN_ROBIN, AMERICAN_WHITE_PELICAN, AMERICAN_WOODCOCK, ATLANTIC_PUFFIN, BALTIMORE_ORIOLE, CALIFORNIA_CONDOR, CALIFORNIA_QUAIL, CANADA_GOOSE, CAROLINA_CHICKADEE,
			CAROLINA_WREN, CHIHUAHUAN_RAVEN, EASTERN_PHOEBE, EASTERN_SCREECH_OWL, GREATER_PRAIRIE_CHICKEN, INCA_DOVE, MISSISSIPPI_KITE, NORTHERN_CARDINAL, EASTERN_KINGBIRD,
			MOUNTAIN_CHICKADEE, NORTHERN_BOBWHITE, NORTHERN_FLICKER, NORTHERN_HARRIER, NORTHERN_SHOVELER, WESTERN_TANAGER};
		   return new HashSet<Bird>(Arrays.asList(birds)); // AMERICAN_AVOCET | AMERICAN_OYSTERCATCHER
		}
		if (type.equals("photographer"))
		{
			Bird[] birds = {AMERICAN_GOLDFINCH, AMERICAN_REDSTART, AMERICAN_WHITE_PELICAN, ASH_THROATED_FLYCATCHER, BLACK_SKIMMER, BLUE_GROSBEAK, BLUE_JAY, BLUE_GRAY_GNATCATCHER, BLUE_WINGED_WARBLER, 
					...
					BLACK_CHINNED_HUMMINGBIRD, BLACK_CROWNED_NIGHT_HERON, BLACK_NECKED_STILT, BLACK_BILLED_MAGPIE, BLACK_VULTURE, FERRUGINOUS_HAWK,
					NORTHERN_BOBWHITE, PAINTED_WHITESTART, PURPLE_GALLINULE, PURPLE_MARTIN, RED_BELLIED_WOODPECKER, RED_BREASTED_NUTHATCH, RED_COCKADED_WOODPECKER, RED_TAILED_HAWK, ROSEATE_SPOONBILL,
					WHITE_BREASTED_NUTHATCH, WHITE_CROWNED_SPARROW, WHITE_FACED_IBIS, WHITE_THROATED_SWIFT, SNOWY_EGRET, VIOLET_GREEN_SWALLOW, YELLOW_BELLIED_SAPSUCKER, YELLOW_BREASTED_CHAT,
					YELLOW_HEADED_BLACKBIRD, YELLOW_RUMPED_WARBLER}; // BARROWS_GOLDENEYE | BRONZED_COWBIRD | BROWN_HEADED_COWBIRD | YELLOW_BILLED_CUCKOO
